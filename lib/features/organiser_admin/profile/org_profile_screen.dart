...
class OrgProfileScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Icon(Icons.corporate_fare_rounded, color: theme.colorScheme.primary, size: 12),
          ...
          // Organisation Stats section
          _SectionHeader('Organisation Overview'),
          const SizedBox(height: 14),
          _SettingsCard(
            child: Column(
              children: [
                _SettingsTile(icon: Icons.local_hospital_rounded, label: 'Clinics Managed (8)', onTap: () {}),
                const Divider(height: 1, indent: 56),
                _SettingsTile(icon: Icons.medical_services_rounded, label: 'Doctors Registered (34)', onTap: () {}),
              ],
            ),
          ),
  ...
  String _formatRole(String role) {
    if (role == 'org_admin' || role == 'organiser_admin') {
      return '✦ Organiser Administrator';
    }
    switch (role) {
